...
# API endpoint to receive drop coordinates
...
def receive_coordinates():
    ...
    # Start the mission in a new thread
    mission_thread = threading.Thread(target=execute_mission, args=(drop_lat, drop_lon))
